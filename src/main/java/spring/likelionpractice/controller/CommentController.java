...
public class CommentController {
    ...
    @Operation(summary = "게시물에 대한 댓글 생성", description = "게시물에 대한 댓글 생성")
    @PostMapping("/comment")
    ...
    @Operation(summary = "게시물에 대한 내가 쓴 댓글 수정", description = "댓글 수정(content, token, commentId ")
    @PutMapping("/comment")
    ...
    @Operation(summary = "게시물에 대한 내가 쓴 댓글 삭제", description = "댓글 삭제(token commentId)")
    ...
    @Operation(summary = "게시물에 대한 댓글 조회", description = "게시물에 대한 댓글 조회(articleId)")
